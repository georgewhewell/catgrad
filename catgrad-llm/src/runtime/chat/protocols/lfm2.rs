...
mod tests {
    ...
    fn passes_universal_scenarios() {
        ...
        ProtocolTestFixture {
            ...
            unknown_tool_call: r##"<|tool_call_start|>[missing()]<|tool_call_end|>"##,
            invalid_args_call: r##"<|tool_call_start|>[add(a="x", b=2)]<|tool_call_end|>"##,
            malformed_payload: r##"<|tool_call_start|>not anything{<|tool_call_end|>"##,
            open_sentinel_only: Some(r##"<|tool_call_start|>"##),
        }
