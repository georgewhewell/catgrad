...
mod tests {
    ...
    fn passes_universal_scenarios() {
        ...
        ProtocolTestFixture {
            ...
            unknown_tool_call: r#"[TOOL_CALLS][{"name":"missing","arguments":{}}]"#,
            invalid_args_call: r#"[TOOL_CALLS][{"name":"add","arguments":{"a":"x","b":2}}]"#,
            malformed_payload: "[TOOL_CALLS]not json",
            open_sentinel_only: Some("[TOOL_CALLS]"),
        }
